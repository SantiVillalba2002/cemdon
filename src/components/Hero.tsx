        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-lg mb-8 font-body">
              Combinamos ciencia médica, nutrición personalizada y tecnología de vanguardia 
              para crear un camino único hacia tu mejor versión.
            </p>
            ...
            >
              <div className="flex -space-x-3">
                {[1, 2, 3, 4].map((i) => (
                  <div
                    key={i}
                    className="w-10 h-10 rounded-full border-2 border-white bg-gradient-to-br from-wellness-sage to-wellness-mist"
                  />
                ))}
              </div>
              <div>
          ...
          >
            ...
            <div className="relative w-72 h-72 md:w-96 md:h-96">
              ...
              {/* Middle ring */}
              <motion.div
                className="absolute inset-4 organic-blob border-2 border-primary/20"
                animate={{ rotate: 360 }}
              ...
              {/* Floating elements */}
              <motion.div
                className="absolute -top-4 right-8 w-16 h-16 rounded-2xl bg-white shadow-soft flex items-center justify-center"
                animate={{ y: [0, -10, 0] }}
              ...
              <motion.div
                className="absolute bottom-8 -left-4 w-14 h-14 rounded-2xl bg-white shadow-soft flex items-center justify-center"
                animate={{ y: [0, 10, 0] }}
              ...
              <motion.div
                className="absolute top-1/2 -right-6 w-12 h-12 rounded-xl bg-white shadow-soft flex items-center justify-center"
                animate={{ y: [0, -8, 0] }}
