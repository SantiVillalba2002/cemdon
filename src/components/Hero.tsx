      ...
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          ease: 'easeOut'
            ...
            <h1 className="font-display text-4xl md:text-5xl lg:text-6xl font-bold leading-tight mb-6">Transformá tu vida con salud integral<span className="text-primary">Transformá</span> tu vida con salud integral
            </h1>
